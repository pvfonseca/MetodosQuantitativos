...
\begin{frame}{Métodos Quantitativos em Economia I: objetivo}
    \begin{center}
        \begin{minipage}{.9\textwidth}
            \NB{\emoji{bullseye} O objetivo da disciplina é apresentar aos alunos as principais técnicas de otimização estática, bem como suas principais aplicações em Economia. \\
...
\begin{frame}{Formato das aulas e sistema de avaliação}
    \begin{itemize}
        ...
        \item As aulas acontecerão às:
              \begin{itemize}
                  \item Segundas-feiras das 10:15 às 11:55
                  \item Terças-feiras das 08:20 às 10:00\bigskip
              \end{itemize}
